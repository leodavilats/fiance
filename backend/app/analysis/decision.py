...
def _verdict_from_mos(mos: Optional[float]) -> Verdict:
...
def decide(
    ...
    if tech:
        ...
        if tech.rsi_14 is not None:
            ...
            if tech.rsi_14 >= 70:
                ...
                reasons.append(f"RSI {tech.rsi_14:.0f}: ativo sobrevendido (possível ponto de entrada).")
    ...
    if avg_cost and current_price:
        ...
        if fair.margin_of_safety is not None and fair.margin_of_safety < MOS_SELL and pnl_pct > 30:
            ...
            reasons.append("Considere realizar parte do lucro: o ativo está caro e você já lucrou bastante.")
