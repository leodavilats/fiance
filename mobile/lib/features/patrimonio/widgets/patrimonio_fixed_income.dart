      ...
      data: (data) {
        ...
        return FiSection(
          ...
          hint:
              ...
              '(${formatPercent(data.rendimentoPct)})',
          action: FiNavAction(
            label: 'Cadastrar e editar aplicações',
  ...
  Widget build(BuildContext context) {
    ...
    return FiDisclosure(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          if (item.vencimentoProximo)
            Padding(
              padding: const EdgeInsets.only(bottom: FiSpace.s2),
              child: FiTag(label: 'Vence em breve', state: FiState.attention),
            ),
          FiRows(
            children: [
              FiDataRow(
              ...
              FiDataRow(
                label: 'Rendimento',
                value: formatCurrency(item.rendimentoAcumulado),
