    ...
    @if (notFound(); as symbol) {
      <div class="max-w-column">
        ...
        <p class="fi-body text-ink-2 m-0 mb-4">
          ...
          não são suportadas — se o ticker existe na B3, pode ser um erro de digitação.
        </p>
    ...
    @if (analysis(); as a) {
      <article class="flex flex-col gap-8">
        <header>
          @if (origem(); as o) {
            <a
              ...
              class="fi-body text-brand no-underline inline-flex items-center gap-1.5 mb-4"
            >
            ...
            <div class="text-right">
              ...
              @if (a.technical.distance_from_52w_high_pct != null) {
                <p class="fi-caption text-ink-3 m-0 mt-1 fi-num">
                  {{ a.technical.distance_from_52w_high_pct | number: '1.1-1' }}% do topo de 52
                  semanas
                </p>
              }
          ...
          <div class="flex items-baseline gap-6 flex-wrap">
            ...
            @if (a.technical.sma_50 != null) {
              <div>
                ...
                <p class="fi-metric-sm text-ink m-0">
                  R$ {{ a.technical.sma_50 | number: '1.2-2' }}
                </p>
              </div>
            }
            @if (a.technical.sma_200 != null) {
              <div>
                ...
                <p class="fi-metric-sm text-ink m-0">
                  R$ {{ a.technical.sma_200 | number: '1.2-2' }}
                </p>
              </div>
            }
          ...
          @if (showMethod()) {
            <dl class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 m-0 max-w-reading">
              ...
              <div>
                ...
                <dd class="fi-body text-ink m-0">
                  {{ ui.trendBasisLabel(a.technical.trend_basis) }}
                </dd>
              </div>
        ...
        <footer class="pt-5 border-t border-hairline fi-caption text-ink-3">
          Cotação e fundamentos da BRAPI. Todo preço justo aqui é estimativa a partir de dado
          público, não recomendação de investimento e não garantia de retorno.
        </footer>
      </article>
    }
  `,
