...
9. **Falta uma das sete regras no Dart: o alvo de toque de 44dp.** `test/lint_ui_test.dart` já
...
10. **`/voce` ainda não está nos quatro eixos, e a home pública continua a antiga.** A
